...
public class MenuItemDaoCollectionImpl implements MenuItemDao{
	...
	public MenuItemDaoCollectionImpl() throws ParseException {
		...
		//MenuItem menuitem2;
		menuItemList.add(new MenuItem(1, "Pizza", 150.00f, true,  DateUtil.convertTo("17/3/2021"), "MainCourse", true));
		menuItemList.add(new MenuItem(2, "Burger", 250.00f, true,  DateUtil.convertTo("18/03/2021"), "MainCourse", true));
	}
