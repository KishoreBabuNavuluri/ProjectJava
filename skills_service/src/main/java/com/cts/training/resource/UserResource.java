...
public class UserResource {
	...
	public ResponseEntity<Optional<Skills>> getSkillsByLevel(@PathVariable String level) {
		Optional<Skills> user=userRepository.findByLevel(level);
	...
	public void deleteSkills(@PathVariable Long id) {
	 ...
	 @PostMapping("/skills")
	    public Skills createUser(@Valid @RequestBody Skills user, UriComponentsBuilder builder) {
